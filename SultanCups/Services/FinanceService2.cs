...
_context.financial_events
    ...
    overPaid > selectedMethodBalance
)
                {
                    return (
                false,
            @"المبلغ المطلوب استرجاعه أكبر من الرصيد المتوفر في نوع الدفع المختار.

الفاتورة تحتوي على أكثر من نوع دفع.

لحل المشكلة:

1- اذهب إلى تعديل الفاتورة.

2- استخدم زر استرجاع دفعة من أنواع الدفع التي تريد الاسترجاع منها.

3- استرجع المبلغ المناسب حسب الكمية المرجعة المطلوبة.
